...
生成日: 2026-07-03 / 全23タスク(not_started: 2 / done: 21)
...
| [T-007](T-007-reporting-schemas.md) | artifact-schema | done | T-003 | 基盤spec schema定義(QualityAnalyticsSnapshot / ReleaseReadinessReport) |
...
| [T-012](T-012-trace-run-id-design.md) | evidence-trace-store | done | T-002, T-003 | trace_id / run_id設計と生成ユーティリティ |
...
| [T-017](T-017-adr-sandbox-runtime.md) | sandbox | done | - | ADR起票 sandbox実現方式決定 |
| [T-018](T-018-sandbox-ephemeral-env.md) | sandbox | done | T-002, T-017 | sandbox ephemeral env(作成・破棄・reset) |
| [T-019](T-019-sandbox-fixture-seed.md) | sandbox | done | T-018 | fixture seed機構とdeterministic clock |
