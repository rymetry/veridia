...
導入内容:
  ...
  docs/istqb-jstqb-syllabus-map.md    → <対象>/quality/istqb-jstqb-syllabus-map.md (同上。ノートの全体地図)
...
[ -f "$SRC/docs/istqb-jstqb-syllabus-map.md" ] || err "docs/istqb-jstqb-syllabus-map.md が見つかりません"
...
# 3b. istqb-jstqb-syllabus-map(シラバス精読ノートの全体地図) → quality/istqb-jstqb-syllabus-map.md
if copy_keep_existing "$SRC/docs/istqb-jstqb-syllabus-map.md" "$TARGET/quality/istqb-jstqb-syllabus-map.md"; then
  echo "istqb-jstqb-syllabus-map: quality/istqb-jstqb-syllabus-map.md へコピーしました"
else
  echo "istqb-jstqb-syllabus-map: 既存の quality/istqb-jstqb-syllabus-map.md を保持しました"
fi
